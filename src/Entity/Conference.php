...
class Conference
{
    ...
    public function addCommentWithPhoto($text, $author, $emailAddress, $photoFilename): Comment
    {
    ...
    public function addCommentWithoutPhoto($text, $author, $emailAddress): Comment
    {
